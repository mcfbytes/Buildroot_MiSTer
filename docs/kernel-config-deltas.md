...
| `RTL8812AU`, `RTL8821AU` (11ac, no mainline USB driver) | **P3.1/v9** — out-of-tree morrownr Buildroot packages. `RTL8188EU`/`RTL8188FU` (→ in-kernel `RTL8XXXU`), `RTL8821CU` (→ `RTW88_8821CU`) and `RTL8822BU` (→ `RTW88_8822BU`) moved to mainline drivers; PR #35 later moved `RTL8814AU` (→ in-kernel `RTW88_8814AU`, see row below) the same way; see [ADR 0016](decisions/0016-mainline-first-wifi-drivers.md) |
