...
> ⚠ **Stock moved to Release 20260907, checked 2026-09-10 (kernel-side, not a
> re-build).** Every table below still measures against the **66-file 20250402
> inventory** (`docs/stock-inventory/20250402/firmware.md`) — this document's
...
was measured against. `docs/stock-inventory/20260907/firmware.md` has been **regenerated from the
...
`docs/stock-inventory/20250402/firmware.md` and diffing it against
...
- **`brcm/BCM20702A1-0b05-17cb.hcd`** — **RESOLVED in P3.14**, no longer a gap.
  ...
  **Update, 2026-09-10:** this file is no longer purely "beyond-stock, ours alone" —
  `evidence/stock-20260907-firmware.txt` shows Release 20260907's stock firmware set now
  ships `brcm/BCM20702A1-0b05-17cb.hcd` too (absent from the 20250402/66-file set this
  document audits against). The P3.14 package's provenance and reasoning (no Buildroot
  Config.in menu, hash-pinned vendor fetch) are unaffected — recorded here because the
  "genuine gap, no stock counterpart" framing above no longer describes the current
  release, only the 20250402 one this document's numbers are still built on.
