...
The variant builds end-to-end (`make rt`, **38 of the 40 shared + 4 beta-local**
carried patches — **42 entries; the two omissions are `0047` and `0050`, both
of which 7.2.x already has in-tree in one form or another, see §2**; three of the
