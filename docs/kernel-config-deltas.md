...
| `RTL8812AU`, `RTL8814AU`, `RTL8821AU` (11ac, no mainline USB driver) | **P3.1/v9** — out-of-tree morrownr Buildroot packages (`RTL8814AU` added in v9). `RTL8188EU`/`RTL8188FU` (→ in-kernel `RTL8XXXU`), `RTL8821CU` (→ `RTW88_8821CU`) and `RTL8822BU` (→ `RTW88_8822BU`) moved to mainline drivers; see [ADR 0016](decisions/0016-mainline-first-wifi-drivers.md) |
| `RTW88_8821CU`, `RTW88_8822CU`, `RTW89_8851BU`, `RTW89_8852BU`, `MT7921U`, `MT7925U`, `ATH9K_HTC`, `CARL9170` | **v9** — mainline USB WiFi broadening ([ADR 0016](decisions/0016-mainline-first-wifi-drivers.md)); firmware via `linux-firmware` sub-options |
| `HID_BETOP_FF`, `HID_BIGBEN_FF`, `HID_MEGAWORLD_FF`, `HID_STEELSERIES` | **v9** — mainline gamepad HID drivers (filled remaining gaps) |
