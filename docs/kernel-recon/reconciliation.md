...
Generated 2026-07-15 06:06 UTC by `reduce.py` from 123 records (108 MiSTer-v5.15 + 15 old-branch residue). Tier-2 verified: 72/123.

| SHA | Branch | Disposition | Carried patch | Severity | Fail | Coupled | Doc✓ | T2 | Subject |
|---|---|---|---|---|---|---|---|---|---|
| `45283785a` | v5.15 | **misclassified** | — | feature-loss | silent | Y | N | ✓ | hid-nintendo: add virtual combo led, don't warn by IMU compe |
| `60821059c` | v5.15 | **misclassified** | — | feature-loss | loud | Y | N | ✓ | hid-nintendo: don't fail if home led is not present. |
| `60e08955f` | v5.15 | **misclassified** | — | cosmetic | silent | — | N | ✓ | dualsense: give mute button and led to system. |
| `b76b4bc6a` | v5.15 | **misclassified** | — | cosmetic | silent | — | N | ✓ | dualsense: leds config for player 6. |
| `f84543926` | v5.15 | **misclassified** | — | feature-loss | silent | Y | N | ✓ | dualsense: add player id led control. |
| `71c583074` | v5.15 | **needs-verification** | 0030-i2c-designware-quiet-timeout.patch | cosmetic | silent | — | Y |  | Disable RTC error messages. |
| `b02a4a011` | v5.15 | **needs-verification** | — | feature-loss | silent | — | Y | ✓ | btusb: support for more CSR clones. |
| `fc09a292a` | v5.15 | **needs-verification** | — | feature-loss | silent | — | ? | ✓ | rtl8821cu: workaround for bad efuse in EDUP EP-AC1661. |
| `97a398176` | v5.15 | **not-evaluated** | — | feature-loss | silent | Y | Y | ✓ | update config. |
| `f0fb626ac` | v5.15 | **not-evaluated** | — | feature-loss | silent | Y | Y | ✓ | defconfig: enable macvlan support (#71) |
...
| `c784a6856` | v5.15 | **carried** | 0016-hid-microsoft-elite2-paddles.patch | feature-loss | silent | Y | Y |  | hid-microsoft: support for XBox Elite 2 paddles. |
...
| `e6df8e30e` | v5.15 | **carried** | 0003-cpufreq-cyclone5-de10nano-overclock.patch | feature-loss | silent | Y | Y |  | Improve clock transition stability and get OSC1 freq from DT |
...
| `e155f6a2f` | v5.15 | **dropped-upstream** | — | feature-loss | silent | Y | Y | ✓ | hid-nintendo: support for Switch NES and SNES controllers. |
...
| `8270e78f4` | v5.15 | **dropped-deliberate** | — | feature-loss | silent | Y | Y |  | xone: backport the paddles from fork. |
...
| `109599db7` | v5.13.12 | **dropped-obsolete** | — | feature-loss | silent | — | Y |  | Update rtl8188eu driver. |
...
| `a6165424f` | v5.13.12 | **dropped-obsolete** | — | none | silent | — | ? |  | xinmotek fix (#11) |
| `a95855a70` | v5.14 | **dropped-obsolete** | — | feature-loss | silent | — | ? |  | dwc2: port from socfpga-v4.19. |
| `d5beb5aa6` | v5.15 | **dropped-obsolete** | — | feature-loss | silent | — | Y |  | xone: sysfs for software pairing. |
| `df35bdb27` | v5.15 | **dropped-obsolete** | 0031-exfat-samsung-symlinks.patch | feature-loss | silent | Y | Y |  | Add exFAT with symlinks support. |
| `ec75e65f8` | v5.13.12 | **dropped-obsolete** | — | none | silent | — | ? |  | Revert "xinmotek fix (#11)" |
